...
module cajapastis (tomasDia=3,
alturaPastillero=25,
diametroExtPastillero=150,
diametroIntPastillero=50,
grosorLateralPastillero=3,
grosorInferiorPastillero=3,
grosorCajonPastillero=1,
